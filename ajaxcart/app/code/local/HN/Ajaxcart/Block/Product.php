 ...
 */
class HN_Ajaxcart_Block_Product extends Mage_Core_Block_Template
{
public function _prepareLayout() {
	...
	public function getProducts() {
		if (!$this->hasData('productid')) {
            $this->setData('productid', Mage::registry('productid'));
        }
    ...
    public function getAllowAttributes($productid)
    {
        return $this->initProduct($productid)->getTypeInstance(true)
            ->getConfigurableAttributes($this->initProduct($productid));
    }
